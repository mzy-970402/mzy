...
<div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                ...
                                <button type="button" class="am-btn am-btn-default am-btn-danger" onclick="selectNotDeleteQj()"><span class="am-icon-trash-o"></span>回收站</button>
                                </div>
                            </div>
                        </div>
              ...
              <option value="selectQj.action" selected = "selected">请假</option>
            </select>
                            </div>
                        </div>
                    </div>
                                      ...
                                      <c:forEach var="row" items="${data_qj}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal1" onclick="editQj1(${row.qj_id})">修改</a>
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal2" onclick="editQj2(${row.qj_id})">查看</a>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="deleteQj(${row.qj_id})"><span class="am-icon-trash-o" ></span> 撤回</button>
                                                    </div>
                                                </div>
                                             </td>
                                        </tr>
...
function deleteQj(qj_id) {
	if(confirm('确实要删除该记录吗?')) {
		...
		$.post("deleteQj.action",{"qj_id":qj_id},function(data){
			if(data=="0"){
				alert("记录删除成功！");
			}else{
				alert("记录删除失败！");
...
function selectNotDeleteQj() {

	window.location.href="selectNotDeleteQj.action";
}
