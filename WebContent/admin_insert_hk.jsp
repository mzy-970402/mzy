         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addHk_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="AdminAddHk.action" method="post" >
                              <div class="am-form-group">
                                   <label for="user-name" class="am-u-sm-3 am-form-label">还款人</label>
                                   <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="hk_hkr"  name="hk_hkr">
                                   </div>
                              </div>
    ...
    elem: '#hk_sqrq' //指定元素
                              ...
                              <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="hk_spr" name="hk_spr" placeholder="">
                                        <small></small>
                                    </div>
                                </div>
