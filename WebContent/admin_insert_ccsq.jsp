 ...
 <div class="tpl-block">
      <div class="am-g">
          <div class="tpl-form-body tpl-form-line">
               <form id="addCcsq_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="AdminAddCcsq.action" method="post" >
                     
                     <div class="am-form-group">
                          <label for="user-name" class="am-u-sm-3 am-form-label">出差事由</label>
                                 <div class="am-u-sm-9">
                                      <input type="text" class="tpl-form-input" id="ccsq_ccsy"  name="ccsq_ccsy" placeholder="">
                                 </div>
                     </div>
                     ...
                     <div class="am-form-group">
                          <label for="user-name" class="am-u-sm-3 am-form-label">申请人</label>
                                 <div class="am-u-sm-9">
                                      <input type="text" class="tpl-form-input" id="ccsq_sqr" name="ccsq_sqr">
                                 </div>
                     </div>
                     
                     <div class="am-form-group">
                          <label for="user-phone" class="am-u-sm-3 am-form-label">费用类别 </label>
                                 <div class="am-u-sm-9">
                                      <select data-am-selected="{searchBox: 1}" id="ccsq_fylb" name="ccsq_fylb">
                     ...
                     <div class="am-form-group">
                          <label for="user-email" class="am-u-sm-3 am-form-label">出差期间 </label>
                                 <div class="am-u-sm-9">
                                      <input type="text" id="ccsq_cfrq" name="ccsq_cfrq" class="am-form-field tpl-form-no-bg" placeholder="请选择出发日期" data-am-datepicker="" readonly/>
                                      <br>
                                      <input type="text" id="ccsq_fhrq" name="ccsq_fhrq"class="am-form-field tpl-form-no-bg" placeholder="请选择返回日期" data-am-datepicker="" readonly/>
                                 </div>
                     </div>
                          
                          
                     <div  class="form-inline">
                          <label for="user-phone" class="am-u-sm-3 am-form-label">出发地 </label>
                                <div id="distpicker2">
        ...
        <div class="form-group">
          ...
          <select class="form-control" id="ccsq_mdd_district" name="ccsq_mdd_district"></select>
                     ...
                     <div class="am-form-group">
                          <label for="user-name" class="am-u-sm-3 am-form-label">出差人员</label>
                                 <div class="am-u-sm-9">
                                      <input type="text" class="tpl-form-input" id="ccsq_ccry" name="ccsq_ccry" placeholder="">
                                 </div>
                     </div>
                      ...
                      <div class="am-form-group">
                           <label for="user-name" class="am-u-sm-3 am-form-label">金额</label>
                                  <div class="am-u-sm-9">
                                       <input type="text" class="tpl-form-input" id="ccsq_jkje" name="ccsq_jkje" placeholder="">
                                  </div>
                      </div>
                      ...
                      <div class="am-form-group">
                           <label for="user-intro" class="am-u-sm-3 am-form-label">备注</label>
                                  <div class="am-u-sm-9">
                                       <textarea class="" rows="2" id="ccsq_bz" name="ccsq_bz" placeholder="请输入"></textarea>
                                  </div>
                      </div>
                      ...
                      <div class="am-form-group">
                           <label for="user-name" class="am-u-sm-3 am-form-label">审批人</label>
                                  <div class="am-u-sm-9">
                                       <input type="text" class="tpl-form-input" id="ccsq_spr" name="ccsq_spr" placeholder="">
                                   </div>
                      </div>
                                
                      <input type="hidden" name="ccsq_state" id="ccsq_state" value="未审批">
