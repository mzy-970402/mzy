         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addJk_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="addJk.action" method="post" >
                              <div class="am-form-group">
                                   <label for="user-name" class="am-u-sm-3 am-form-label">借款人</label>
                                   <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="jk_jkr"  name="jk_jkr" value=${sessionScope.user_name}>
                                   </div>
                              </div>
                                
                              <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">借款事由</label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="3" id="jk_jksy" name="jk_jksy" placeholder="请输入"></textarea>
                                    </div>
                              </div>
                                
                              
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">借款金额</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="jk_jkje" name="jk_jkje" placeholder="">
                                    </div>
                                </div>
