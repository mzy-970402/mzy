                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" action="addClbx.action" method="post">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="clbx_sqr" name="clbx_sqr" placeholder="">
                                        <small></small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="am-form-field tpl-form-no-bg" name="clbx_date" id="clbx_date" placeholder="" data-am-datepicker="" readonly />
                                        <small>日期为必填</small>
                                    </div>
                                </div>
                               ...
                               <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            ...
                                            <i class="am-icon-cloud-upload"></i>上传发票</button>
                                            <input id="clbx_fp" type="file"  id="clbx_fp" multiple>
                                        </div>
