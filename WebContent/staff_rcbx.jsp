     ...
     <div class="tpl-portlet-components">
         <div class="portlet-title">
              <div class="caption font-green bold">
                   <span class="am-icon-code"></span> 日常报销
              </div>
         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addRcbx_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="addRcbx.action" method="post" >
                              ...
                              <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="rcbx_sqr" name="rcbx_sqr" value=${sessionScope.user_name}>
                                    </div>
                              </div>
                              ...
                              <div class="am-form-group">
                               ...
                               <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select  id="rcbx_spr" name="rcbx_spr">
