         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addQj_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="addQj.action" method="post" >
                             
                                
                              <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">申请人</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="qj_sqr" name="qj_sqr" value=${sessionScope.user_name}>
                                    </div>
                              </div>
