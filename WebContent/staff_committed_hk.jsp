...
<div class="tpl-content-wrapper">
     ...
     <ol class="am-breadcrumb">
         ...
         <li class="am-active">还款</li>
     </ol>
     <div class="tpl-portlet-components">
         <div class="portlet-title">
              <div class="caption font-green bold">
                   <span class="am-icon-code"></span> 还款
              </div>
...
<div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                ...
                                <button type="button" class="am-btn am-btn-default am-btn-danger" onclick="selectNotDeleteHk()"><span class="am-icon-trash-o"></span>回收站</button>
                                </div>
                            </div>
                        </div>
              ...
              <option value="selectHk.action" selected = "selected">还款</option>
                        ...
                        <div class="am-u-sm-12" id="demo">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            <th class="table-title">还款人</th>
                                            <th class="table-title">申请日期</th>
                                            <th class="table-title">事由</th>                
                                            <th class="table-title">还款金额</th>
                                    ...
                                    <tbody>
                                      <c:forEach begin="0" step="1" items="${user_hk}" var="row" varStatus="userHk">
                                        <tr>
                                            <td>${row.hk_hkr}</td>
                                            <td>${row.hk_sqrq}</td>
                                            <td>${row.hk_sy}</td>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal1" onclick="editHk1(${row.hk_id})">修改</a>
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal2" onclick="editHk2(${row.hk_id})">查看</a>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="deleteHk(${row.hk_id})"><span class="am-icon-trash-o" ></span> 撤回</button>
                                                  </div>
                                                  </div>
                                             </td>
                                        </tr>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   ...
   <div class="modal-body">
	  <form class="form-horizontal" id="hk_form" enctype="multipart/form-data" action="updateHk.action" method="post">
		<input type="hidden" id="hk_id" name="hk_id"/>
		  
		  <div class="form-group">
		   <label for="edit_record_hospital" class="col-sm-2 control-label">还款人</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="hk_hkr"  name="hk_hkr">
			</div>
		  </div>
		  
		  
		  <div class="form-group">
		   <label for="edit_record_number" class="col-sm-2 control-label">申请日期</label>
		    <div class="col-sm-10">
			    <input type="text" class="layui-input" id="hk_sqrq" name="hk_sqrq">
	        </div>
		  </div>
		  
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">事由</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="hk_sy"  name="hk_sy">
			</div>
		  </div>
		  ...
		  <div class="form-group">
		   <label for="edit_record_number" class="col-sm-2 control-label">还款金额</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="hk_hkje"  name="hk_hkje">
	        </div>
		  </div>
		  
		   <div class="form-group">
		   <label for="edit_record_number" class="col-sm-2 control-label">备注</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="hk_bz"  name="hk_bz">
	        </div>
		  </div>
		  
		
		  <div class="form-group">
		   <label for="edit_record_number" class="col-sm-2 control-label">附件</label>
		    <div class="col-sm-10">
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批人</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="hk_spr"  name="hk_spr">
			</div>
		  </div>
...
function deleteHk(hk_id) {
	if(confirm('确实要删除该记录吗?')) {
		
		$.post("deleteHk.action",{"hk_id":hk_id},function(data){
			if(data=="0"){
				alert("记录删除成功！");
			}else{
				alert("记录删除失败！");
...
function selectNotDeleteHk() {

	window.location.href="selectNotDeleteHk.action";
}
