...
<!-- ------------------------------------------------------------------------------------------------- -->
    ...
    <script type="text/javascript">
        ...
        clbx.onclick = function () {
        	window.location.href = "selectClbx.action"
    ...
    <script type="text/javascript">
        ...
        rcbx.onclick = function () {
        	window.location.href = "selectRcbx.action"
      
        	
        }
     </script>
     <script type="text/javascript">
        let ccsq = document.querySelector(".ccsq");
        ccsq.onclick = function () {
        	window.location.href = "selectCcsq.action"
    ...
    <script>
        ...
        jk.onclick = function () {
        	window.location.href="selectJk.action"
        }
    </script>
    <script>
        let hk = document.querySelector(".hk");
        hk.onclick = function () {
        	window.location.href="selectHk.action"
        }
    </script>
    <script>
        let qj = document.querySelector(".qj");
        qj.onclick = function () {
        	window.location.href="selectQj.action"
        }
    </script>
