                ...
                <ul class="tpl-left-nav-menu" >
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block;">
                            <li>
                                <a href="selectNotApproved.action" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>未审批</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>
...
<div class="tpl-content-wrapper">
     ...
     <ol class="am-breadcrumb">
         <li>我的审批</li>
         <li class="am-active">未审批</li>
     </ol>
     <div class="tpl-portlet-components">
         <div class="portlet-title">
              <div class="caption font-green bold">
                   <span class="am-icon-code"></span> 未审批
...
<div class="tpl-block">
              ...
              <option value="selectNotApproved.action" selected = "selected">未审批</option>
              <option value="selectApproved.action">已审批</option>
                                      ...
                                      <c:forEach begin="0" step="1" items="${userClbx}" var="row" varStatus="userClbx">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal1" onclick="handleClbx(${row.clbx_id})">处理</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal2" onclick="handleRcbx(${row.rcbx_id})">处理</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal3" onclick="handleCcsq(${row.ccsq_id})">处理</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal4" onclick="handleJk(${row.jk_id})">处理</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal5" onclick="handleHk(${row.hk_id})">处理</a>
                                        ...
                                        <c:forEach begin="0" step="1" items="${userQj}" var="row" varStatus="userQj">
                                        <tr>
                                            <td>请假</td>
                                            <td>${row.qj_qjsy}</td>
                                            <td>${row.qj_spr}</td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal6" onclick="handleQj(${row.qj_id})">处理</a>
		...
		<input type="hidden" id="clbx_id" name="clbx_id"/>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批意见</label>
		    <div class="col-sm-10">
			   <textarea class="form-control" rows="4" id="clbx_advice" name="clbx_advice" placeholder="请输入"></textarea>
			</div>
		  </div>
		 ...
		 <div class="modal-footer">
			...
			<button type="button" class="btn btn-primary" onclick="returnClbx()">退回</button>
			<button type="button" class="btn btn-primary" onclick="agreeClbx()">同意</button>
		 </div>
		 </form>
	</div>
  </div>
	  ...
	  <form class="form-horizontal" id="rcbx_sp_form" enctype="multipart/form-data" action="updateRcbx.action" method="post">
		<input type="hidden" id="rcbx_id" name="rcbx_id"/>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批意见</label>
		    <div class="col-sm-10">
			   <textarea class="form-control" rows="4" id="rcbx_advice" name="rcbx_advice" placeholder="请输入"></textarea>
			</div>
		  </div>
		 ...
		 <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			<button type="button" class="btn btn-primary" onclick="returnRcbx()">退回</button>
			<button type="button" class="btn btn-primary" onclick="agreeRcbx()">同意</button>
		 </div>
		 </form>
	</div>
  </div>
	  ...
	  <form class="form-horizontal" id="ccsq_sp_form" enctype="multipart/form-data" action="updateCcsq.action" method="post">
		<input type="hidden" id="ccsq_id" name="ccsq_id"/>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批意见</label>
		    <div class="col-sm-10">
			   <textarea class="form-control" rows="4" id="ccsq_advice" name="ccsq_advice" placeholder="请输入"></textarea>
			</div>
		  </div>
		 ...
		 <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			<button type="button" class="btn btn-primary" onclick="returnCcsq()">退回</button>
			<button type="button" class="btn btn-primary" onclick="agreeCcsq()">同意</button>
		 </div>
		 </form>
	</div>
  </div>
	  ...
	  <form class="form-horizontal" id="jk_sp_form" enctype="multipart/form-data" action="updateJk.action" method="post">
		<input type="hidden" id="jk_id" name="jk_id"/>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批意见</label>
		    <div class="col-sm-10">
			   <textarea class="form-control" rows="4" id="jk_advice" name="jk_advice" placeholder="请输入"></textarea>
			</div>
		  </div>
		 ...
		 <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			<button type="button" class="btn btn-primary" onclick="returnJk()">退回</button>
			<button type="button" class="btn btn-primary" onclick="agreeJk()">同意</button>
		 </div>
		 </form>
	</div>
  </div>
	  ...
	  <form class="form-horizontal" id="hk_sp_form" enctype="multipart/form-data" action="updateHk.action" method="post">
		<input type="hidden" id="hk_id" name="hk_id"/>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批意见</label>
		    <div class="col-sm-10">
			   <textarea class="form-control" rows="4" id="hk_advice" name="hk_advice" placeholder="请输入"></textarea>
			</div>
		  </div>
		 ...
		 <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			<button type="button" class="btn btn-primary" onclick="returnHk()">退回</button>
			<button type="button" class="btn btn-primary" onclick="agreeHk()">同意</button>
		 </div>
		 </form>
	</div>
  </div>
	  ...
	  <form class="form-horizontal" id="qj_sp_form" enctype="multipart/form-data" action="updateQj.action" method="post">
		<input type="hidden" id="qj_id" name="qj_id"/>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批意见</label>
		    <div class="col-sm-10">
			   <textarea class="form-control" rows="4" id="qj_advice" name="qj_advice" placeholder="请输入"></textarea>
			</div>
		  </div>
		 ...
		 <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
			<button type="button" class="btn btn-primary" onclick="returnQj()">退回</button>
			<button type="button" class="btn btn-primary" onclick="agreeQj()">同意</button>
		 </div>
		 </form>
	</div>
  </div>
...
function agreeRcbx() {
	$.post("<%=basePath%>agreeRcbx.action",$("#rcbx_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function returnRcbx() {
	$.post("<%=basePath%>returnRcbx.action",$("#rcbx_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function agreeCcsq() {
	$.post("<%=basePath%>agreeCcsq.action",$("#ccsq_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function returnCcsq() {
	$.post("<%=basePath%>returnCcsq.action",$("#ccsq_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function agreeJk() {
	$.post("<%=basePath%>agreeJk.action",$("#jk_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function returnJk() {
	$.post("<%=basePath%>returnJk.action",$("#jk_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function agreeHk() {
	$.post("<%=basePath%>agreeHk.action",$("#hk_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function returnHk() {
	$.post("<%=basePath%>returnHk.action",$("#hk_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function agreeQj() {
	$.post("<%=basePath%>agreeQj.action",$("#qj_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
...
function returnQj() {
	$.post("<%=basePath%>returnQj.action",$("#qj_sp_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务审批完成");
		}else{
			alert("任务审批未完成");
