...
<div class="tpl-content-wrapper">
     ...
     <ol class="am-breadcrumb">
         <li>我的申请</li>
         <li><a href="staff_txsqd.jsp">填写申请单</a></li>
         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addHk_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="addHk.action" method="post" >
                              <div class="am-form-group">
                                   <label for="user-name" class="am-u-sm-3 am-form-label">还款人</label>
                                   <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="hk_hkr"  name="hk_hkr" value=${sessionScope.user_name}>
                                   </div>
                              </div>
                              
                              <div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">申请日期 </label>
                                    <div class="am-u-sm-9">
...
layui.use('laydate', function(){
  ...
  laydate.render({
    elem: '#hk_sqrq' //指定元素
                              ...
                              <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">事由</label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="3" id="hk_sy" name="hk_sy" placeholder="请输入"></textarea>
                                    </div>
                              </div>
                                
                              
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">还款金额</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="hk_hkje" name="hk_hkje" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="hk_bz" name="hk_bz" placeholder="">
                                    </div>
                                </div>
                                
                                 <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">附件</label>
