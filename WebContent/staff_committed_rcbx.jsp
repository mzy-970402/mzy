...
<div class="tpl-block">
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                  ...
                                  <button type="button" class="am-btn am-btn-default am-btn-danger" onclick="selectNotDeleteRcbx()"><span class="am-icon-trash-o"></span>回收站</button>
                                </div>
                            </div>
                        </div>
              ...
              <option value="selectRcbx.action" selected = "selected">日常报销</option>
                                      ...
                                      <c:forEach var="row" items="${data_rcbx}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal1" onclick="editRcbx1(${row.rcbx_id})">修改</a>
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal2" onclick="editRcbx2(${row.rcbx_id})">查看</a>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="deleteRcbx(${row.rcbx_id})"><span class="am-icon-trash-o" ></span> 撤回</button>
                                                    </div>
                                                </div>
                                             </td>
                                        </tr>
...
function deleteRcbx(rcbx_id) {
	if(confirm('确实要删除该记录吗?')) {
		
		$.post("deleteRcbx.action",{"rcbx_id":rcbx_id},function(data){
			if(data=="0"){
				alert("记录删除成功！");
			}else{
				alert("记录删除失败！");
...
function selectNotDeleteRcbx() {

	window.location.href="selectNotDeleteRcbx.action";
}
