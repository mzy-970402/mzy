         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addJk_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="AdminAddJk.action" method="post" >
                              <div class="am-form-group">
                                   <label for="user-name" class="am-u-sm-3 am-form-label">借款人</label>
                                   <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="jk_jkr"  name="jk_jkr">
                                   </div>
                              </div>
                              ...
                              <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="jk_spr" name="jk_spr" placeholder="">
                                        <small></small>
                                    </div>
                                </div>
