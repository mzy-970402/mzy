     ...
     <div class="tpl-portlet-components">
         <div class="portlet-title">
              <div class="caption font-green bold">
                   <span class="am-icon-code"></span> 添加日常报销
              </div>
         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addRcbx_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="AdminAddRcbx.action" method="post" >
                              <div class="am-form-group">
                                   <label for="user-name" class="am-u-sm-3 am-form-label">报销事由</label>
                                   <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="rcbx_bxsy"  name="rcbx_bxsy" placeholder="">
                                   </div>
                              </div>
                              ...
                              <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="rcbx_sqr" name="rcbx_sqr">
                                    </div>
                              </div>
                              ...
                              <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" id="rcbx_sqlb" name="rcbx_sqlb">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="rcbx_je" name="rcbx_je" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="date" class="am-form-field tpl-form-no-bg" name="rcbx_date" id="rcbx_date" placeholder="" data-am-datepicker="" />
                               ...
                               <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="2" id="rcbx_bz" name="rcbx_bz" placeholder="请输入"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="rcbx_spr" name="rcbx_spr" placeholder="">
                                        <small></small>
                                    </div>
                                </div>
                                
                                     <input type="hidden" name="rcbx_state" id="rcbx_state" value="未审批">
...
function addClbx() {
	$.post("<%=basePath%>addRcbx.action",$("#addRcbx_form").serialize(),function(data){
		if(data=="0"){
		    alert("任务已提交给审批人");
		}else{
			alert("任务提交失败");
