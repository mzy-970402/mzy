 ...
 <div class="tpl-block">
      <div class="am-g">
          <div class="tpl-form-body tpl-form-line">
               <form id="addCcsq_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="addCcsq.action" method="post" >
                     ...
                     <div class="am-form-group">
                          <label for="user-name" class="am-u-sm-3 am-form-label">申请人</label>
                                 <div class="am-u-sm-9">
                                      <input type="text" class="tpl-form-input" id="ccsq_sqr" name="ccsq_sqr" value=${sessionScope.user_name}>
                                 </div>
                     </div>
                     ...
                     <div class="am-form-group">
                      ...
                      <div class="am-form-group">
                           <label for="user-name" class="am-u-sm-3 am-form-label">审批人</label>
                                  <div class="am-u-sm-9">
                                     <select  id="ccsq_spr" name="ccsq_spr">
