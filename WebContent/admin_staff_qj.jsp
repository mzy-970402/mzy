                         ...
                         <ul class="tpl-left-nav-sub-menu" style="display: block;">
                            <li>
                               <a href="AdminSelectClbxAndRcbx.action">
                                ...
                                <a href="AdminSelectQj.action" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>请假管理</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>
     ...
     <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success" onclick="tzQj()"><span class="am-icon-plus"></span> 新增</button>
                               </div>
                            </div>
                        </div>
			            ...
			            <table class="am-table am-table-striped am-table-hover table-main">
			                <thead>
			                    <tr>
			                        ...
			                        <th class="table-type">请假事由</th>
			                        <th class="table-date am-hide-sm-only">请假类型</th>
			                        <th class="table-date am-hide-sm-only">请假天数</th>
            ...
            <tr>
                ...
                <td>
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal1" onclick="AdminSelectOneQj(${row.qj_id})">查看</a>
                            <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="AdminDeleteOneQj(${row.qj_id})"><span class="am-icon-trash-o" ></span>删除</button>
                      </div>
                      </div>
                 </td>
            </tr>
...
<li><a  href="<%=request.getContextPath()%>/AdminSelectQj.action?page=${page6.firstPage}">首页</a></li>
<li><a href="AdminSelectQj.action?page=${page6.prePage}">上一页</a></li>
<c:forEach var="s" begin="1" end="${page6.pages}">  
<li><a class="cur" href="<%=request.getContextPath()%>/AdminSelectQj.action?page=${s}">${s}</a></li>  
</c:forEach>  
<li><a href="AdminSelectQj.action?page=${page6.nextPage}">下一页</a></li>
<li><a  href="<%=request.getContextPath()%>/AdminSelectQj.action?page=${page6.lastPage}">尾页</a></li>  
</ul>  
</form>   
    </div>
    </div>
...
<script src="<%=basePath%>js/sb-admin-2.js"></script>
    ...
    function tzQj()
    {
    	window.location.href="admin_insert_qj.jsp";
    }
    function AdminSelectOneQj(id) {
		$.ajax({
			type:"get",
			url:"<%=basePath%>AdminSelectOneQj.action",
			data:{"qj_id":id},
    ...
    function AdminDeleteOneQj(qj_id) {
    	if(confirm('确实要删除该记录吗?')) {
    		$.post("AdminDeleteOneQj.action",{"qj_id":qj_id},function(data){
    			if(data=="0"){
    				alert("删除成功！");
    			}else{
    				alert("删除失败！");
