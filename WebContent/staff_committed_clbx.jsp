...
<div class="tpl-block">
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    ...
                                    <button type="button" class="am-btn am-btn-default am-btn-danger" onclick="selectNotDeleteClbx()"><span class="am-icon-trash-o"></span>回收站</button>
                                </div>
                            </div>
                        </div>
              ...
              <option value="selectClbx.action" selected = "selected">差旅报销</option>
                                      ...
                                      <c:forEach begin="0" step="1" items="${userClbx}" var="row" varStatus="userClbx">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal1" onclick="editClbx1(${row.clbx_id})">修改</a>
                                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal2" onclick="editClbx2(${row.clbx_id})">查看</a>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="deleteClbx(${row.clbx_id})"><span class="am-icon-trash-o" ></span> 撤回</button>
                                                  </div>
                                                  </div>
                                             </td>
                                        </tr>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   ...
   <div class="modal-body">
	  <form class="form-horizontal" id="clbx_form" enctype="multipart/form-data" action="updateClbx.action" method="post">
		<input type="hidden" id="clbx_id" name="clbx_id"/>
		  
		  <div class="form-group">
		   <label for="edit_record_hospital" class="col-sm-2 control-label">报销事由</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="clbx_bxsy"  name="clbx_bxsy">
			</div>
		  </div>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">申请人</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="clbx_sqr"  name="clbx_sqr">
			</div>
		  </div>
		  ...
		  <div class="form-group">
		   <label for="edit_record_sickroom" class="col-sm-2 control-label">申请类别</label>
		    <div class="col-sm-10">
			   <select  id="clbx_sqlb" name="clbx_sqlb">
		  ...
		  <div class="form-group">
		   <label for="edit_record_number" class="col-sm-2 control-label">金额</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="clbx_je"  name="clbx_je">
	        </div>
		  </div>
    ...
    elem: '#clbx_date' //指定元素
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">备注</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="clbx_bz"  name="clbx_bz">
			</div>
		  </div>
		  ...
		  <div class="form-group">
		   <label for="edit_record_section" class="col-sm-2 control-label">审批人</label>
		    <div class="col-sm-10">
			   <input type="text" class="form-control" id="clbx_spr"  name="clbx_spr">
			</div>
		  </div>
...
function deleteClbx(clbx_id) {
	if(confirm('确实要删除该记录吗?')) {
		...
		$.post("deleteClbx.action",{"clbx_id":clbx_id},function(data){
			if(data=="0"){
				alert("记录删除成功！");
			}else{
				alert("记录删除失败！");
