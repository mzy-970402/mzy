     ...
     <div class="tpl-portlet-components">
         <div class="portlet-title">
              <div class="caption font-green bold">
                   <span class="am-icon-code"></span> 请假
              </div>
         ...
         <div class="tpl-block">
              <div class="am-g">
                   <div class="tpl-form-body tpl-form-line">
                        <form id="addQj_form" enctype="multipart/form-data" class="am-form tpl-form-line-form" action="AdminAddQj.action" method="post" >
                             
                                
                              <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">申请人</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="qj_sqr" name="qj_sqr">
                                    </div>
                              </div>
                                
                              <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">请假类型 </label>
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" id="qj_qjlx" name="qj_qjlx">
                                ...
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">请假天数</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="qj_qjts" name="qj_qjts" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label">请假事由</label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="2" id="qj_qjsy" name="qj_qjsy" placeholder="请输入"></textarea>
                                    </div>
                                </div>
                               ...
                               <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="qj_spr" name="qj_spr" placeholder="">
                                        <small></small>
                                    </div>
                                </div>
                                
                                     <input type="hidden" name="qj_state" id="qj_state" value="未审批">
